 ...
 * </p>
 * <p>
 *     The links between the nodes are uni-directional
 * </p>
 * @param <T> The type of the elements contained in the graph
 */
public class OrientedGraphNode<T> extends GraphNode<T> {
    public OrientedGraphNode(T value, ArrayList<GraphNode<T>> linked) {
        super(value);
        link(linked);
    }
